<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Main.master" AutoEventWireup="true"
    CodeFile="MessageToAdmin.aspx.cs" Inherits="Sections_Profile_My_MessageToAdmin" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContentPlaceHolder" runat="Server">
    ...
    <meta name="keywords" content="отправить сообщение администратору" />
    <meta name="description" content="Отправить сообщение администратору" />
    <title>Отправить сообщение администратору</title>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div id="content">
        ...
        <div>
            |<a href="Profile.aspx">Мой профиль</a>| |<a href="MessageToAdmin.aspx"><span class="thispage">Отправить
                сообщение администратору</span></a>|
        </div>
        <div class="filler">
        </div>
        <div class="warning">
