...
public partial class Sections_Profile_Admin_MessageToRoot : System.Web.UI.Page
{
    ...
    protected void sendButton_Click(object sender, EventArgs e)
    {
        ...
        if (isValid)
        {
            ...
            try
            {
                ...
                String insertCommandString = "INSERT INTO AdminMessages(SubjectText,MessageText,MessageDate,UserID)"
